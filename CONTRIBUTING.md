...
The server currently supports 28 datasets. To add a new one:
...
This runs tests covering all 28 datasets across all 4 tools, plus negative/error-path tests. Tests hit the live MoSPI API with a 0.5s throttle between calls to avoid rate-limiting.
