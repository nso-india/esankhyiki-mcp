...
**Key Features:**
- 23 statistical datasets covering employment, inflation, industrial production, GDP, energy, renewable energy, higher education, school education, gender, health, environment, trade, agriculture, consumption, economic census, telecom usage, and digital literacy
...
| **NSS80** | NSS 80th Round (CMST + CMSE) | Mobile phone ownership, internet usage, online banking, cybercrime, household telecom connectivity, school enrolment and expenditure, course fees, private coaching |
